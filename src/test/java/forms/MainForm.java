...
public class MainForm extends Form {
    ...
    public MainForm() {
        super(By.xpath("//ul[@class='pagination pagination--center']"), "Main page");
    }
    ...
    public boolean isMainPage() {
        return getFormLabel().state().isDisplayed();
    }

    public int getCurrentPageNumber() {
        return Character.getNumericValue(lblPageNumber.getText().charAt(0));
    }
}
